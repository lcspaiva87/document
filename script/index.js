  ...
  document.addEventListener("DOMContentLoaded", function () {
    var Accordion = function (el, multiple) {
      ...
      for (var i = 0; i < dropdownlink.length; i++) {
        dropdownlink[i].addEventListener(
          "click",
          function (e) {
            var $el = e.data.el,
            ...
            if (!e.data.multiple) {
              ...
              var submenuItems = $el.querySelectorAll(".submenuItems");
              for (var j = 0; j < submenuItems.length; j++) {
                if (submenuItems[j] !== $next) {
                  submenuItems[j].style.display = "none";
                  submenuItems[j].parentNode.classList.remove("open");
                }
              }
            }
          },
    ...
    var accordion = new Accordion(
      document.querySelector(".accordion-menu"),
      false
    );
  });
